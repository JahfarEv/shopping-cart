...
const search=  product.filter((val)=>{
  ...
  return (
    ...
    <div className='templateContainer ' style={{display:'flex',justifyContent:'center',margin:'10px'}}>
      <div className='searchInput_Container'>
        <input style={{width:'350px'}} id='searchInput' type='text' placeholder='Search here...' onChange={(event)=>{
